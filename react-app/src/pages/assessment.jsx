          ...
          render={({ triggerSave, canvas, imageDownloadUrl }) => (
            <div className="flex flex-col justify-center">
                ...
                <button
                    ...
                    className={`${!isScore ? '' : 'hidden'} ml-auto mr-auto mt-6 w-36 text-2xl bg-blue-400 text-white px-6 py-2 rounded-lg hover:bg-blue-500 focus:outline-none focus:ring focus:border-blue-300`}>
                    Save
                </button>
                {imageDownloadUrl ? (
                    <button
                        ...
                        className={`${!isScore ? '' : 'hidden'} ml-auto mr-auto mt-6 w-36 text-4xl bg-blue-800 text-white px-6 py-2 rounded-lg hover:bg-blue-800 focus:outline-none focus:ring focus:border-blue-300`}>
                        Finish
                    </button>
                ) : null}
                      {imageDownloadUrl ? (
        ...
        <div>
            ...
            <div className='bg-gray-200 w-screen h-draw flex flex-col justify-start items-center bg-gradient-to-r from-indigo-500 via-purple-300 to-red-400'>
                ...
                <div className="mt-6">
                    <button
                        onClick={handleNext}
                        className={`${isScore ? '' : 'hidden'} text-4xl bg-blue-800 text-white px-6 py-2 rounded-lg hover:bg-blue-800 focus:outline-none focus:ring focus:border-blue-300`}>
                        Next
                    </button>
                </div>
            </div>
